...
public async Task RemoveAsync(int id)
 ...
 if (string.IsNullOrWhiteSpace(search))
  ...
  var results = await _categoryRepository.FindAsync(c => c.Name.Contains(search, StringComparison.OrdinalIgnoreCase));
...
if (string.IsNullOrWhiteSpace(newName))
 ...
 if (category == null)
  ...
  throw new InvalidOperationException($"ID-si {id} olan category tapilmadi.");
            ...
            var existingCategory = await _categoryRepository.FirstOrDefaultAsync(c => c.Name.Equals(newName, StringComparison.OrdinalIgnoreCase) && c.Id != id);
